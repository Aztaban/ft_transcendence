...
**Also touches this issue:** Martin (Backend), Lenka (Backend), Diana (Project list/detail UI)
...
**Also touches this issue:** Martin (Backend), Lenka (Backend), Diana (Selection form & Head Tutor review table UI)
...
**Also touches this issue:** Martin (Backend), Lenka (Backend), Diana (Request form & Requests page UI)
...
**Your role:** Integration into Hitchhiker dashboard
...
**Your role:** Integration into Student dashboard
...
**Also touches this issue:** Diana (UI)
