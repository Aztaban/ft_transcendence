...
**Also touches this issue:** Roman (DB model & migration), Lenka (API-facing fields)
...
**Also touches this issue:** Lenka (Backend endpoint), Diana (Registration form UI), Lada (Form-to-API integration)
...
**Also touches this issue:** Lenka (Backend session/login), Diana (Login page UI), Lada (Integration)
...
**Also touches this issue:** Lenka (Backend OAuth flow), Roman (Provider config/infra)
...
**Also touches this issue:** Lenka (Backend), Diana (Profile page UI), Lada (Integration)
...
**Also touches this issue:** Lenka (Backend upload endpoint), Diana (UI), Roman (File storage infra)
