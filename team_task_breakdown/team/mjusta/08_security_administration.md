...
**Also touches this issue:** Lenka (Backend), Diana (Frontend route protection)
...
**Also touches this issue:** Lenka (Backend), Roman (Infra/secrets management)
...
**Also touches this issue:** Lenka (Backend), Roman (Log storage infra)
