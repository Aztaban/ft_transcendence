...
**Your role:** Backend/API docs

**Also touches this issue:** Diana (Coordinates as Scrum Master), Martin (Backend/API docs), Roman (Infra/deployment docs), Lada (Frontend integration docs)
...
### 2. Prepare Evaluation Demo

**Also touches this issue:** Diana (Coordinates), Martin, Roman, Lada
