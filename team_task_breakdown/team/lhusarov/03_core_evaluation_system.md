...
**Also touches this issue:** Martin (Backend), Diana (Project list/detail UI), Lada (Integration)
...
**Also touches this issue:** Martin (Backend), Diana (Selection form & Head Tutor review table UI), Lada (Integration)
...
**Also touches this issue:** Martin (Backend), Diana (Request form & Requests page UI), Lada (Integration)
...
**Also touches this issue:** Martin (Backend), Lada (Integration into Hitchhiker dashboard)
...
**Also touches this issue:** Martin (Backend), Lada (Integration into Student dashboard)
...
**Also touches this issue:** Martin (Backend), Lada (Integration)
...
**Also touches this issue:** Martin (Backend), Diana (UI)
