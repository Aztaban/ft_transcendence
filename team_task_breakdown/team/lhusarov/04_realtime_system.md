...
**Also touches this issue:** Roman (Infra (Nginx WS proxy, Redis channel layer)), Martin (Django Channels backend)
...
**Also touches this issue:** Martin (Backend), Lada (Frontend indicators)
