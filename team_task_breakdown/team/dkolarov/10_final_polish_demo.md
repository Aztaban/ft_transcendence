...
### 1. Improve Final User Experience

**Also touches this issue:** Lada
...
**Your role:** Coordinates as Scrum Master

**Also touches this issue:** Martin (Backend/API docs), Lenka (Backend/API docs), Roman (Infra/deployment docs), Lada (Frontend integration docs)
...
### 3. Prepare Evaluation Demo

**Your role:** Coordinates

**Also touches this issue:** Martin, Lenka, Roman, Lada
